<x-guest-layout :title="'SSLCheckout - ' . config('app.name')">
            ...
            <div class="col-md-4 order-md-2 mb-4">
                ...
                <ul class="list-group mb-3">
                    @if (count($cartItems) > 0)
                        @foreach ($cartItems as $cartItem)
                            <li class="list-group-item d-flex justify-content-between lh-condensed">
                                ...
                                <span class="text-muted">{{ $cartItem['quantity'] * $cartItem['price'] }}</span>
                            </li>
                        @endforeach
                    @endif
                    ...
                    <li class="list-group-item d-flex justify-content-between">
                        ...
                        <strong>{{ $cart['shipping_cost'] }} TK</strong>
                    </li>
                    <li class="list-group-item d-flex justify-content-between">
                        <span>Total (BDT)</span>
            ...
            <div class="col-md-8 order-md-1">
                ...
                <form method="POST" class="needs-validation" novalidate>
                    ...
                    <div class="custom-control custom-checkbox">
                        ...
                        <input type="hidden" value="{{ $cart['total'] }}" name="amount" id="total_amount_ssl" required />
