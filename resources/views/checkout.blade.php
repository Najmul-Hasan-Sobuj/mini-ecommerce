    ...
    <div class="container">
        <div class="row mt-4">
            <div class="col-lg-6">
                ...
                <div class="row mx-1">
                    <h4 class="text-title my-3">Shipping method</h4>
                    <div class="col-lg-12 ml-0 p-0 check-area">
                        <div class="form-check mb-0">
                            <label class="form-check-label d-flex align-items-center py-3 border pl-5 shipping_method"
                                style="border-top-right-radius: 5px;border-top-left-radius: 5px;">
                                <input type="radio" class="form-check-input mr-3 mt-0 "
                            ...
                            <div class="card-header border-0 custom-card-header bg-white">
                                <h5 class="mb-0">
                                    <label class="mb-0 d-flex align-items-center custom-card-header">
                                        ...
                                        <p style="margin-left: 1rem;font-size: 16px;color: black;">
                                            SSLCOMMERZ
                                        </p>
                                    </label>
                                </h5>
                                ...
                                <div class="card-body" style="background-color: #f7f7f7">
                                    ...
                                    <div class="row mt-5 mb-5">
                                        <div class="col-lg-12 col-sm-12 col-12 text-center">
                                            <form action="{{ route('sslPayment') }}" method="POST">
                                                <input class="total_value" type="hidden" name="total"
                                                    value="{{ $total }}">
                                                <input class="shipping_cost_value" type="hidden" name="shipping_cost"
                                                    value="0">
                                                @csrf
                                                <button type="submit"
                                            ...
                                            <div class="col-lg-12 col-sm-12 col-12 p-0 pt-2">
                                                <div class="checkbox-wrapper-4">
                                                    ...
                                                    <label class="cbx" for="morning"><span>
                                                            ...
                                                            </svg></span><span>Email me with news and
                                                            offers</span></label>
                                            ...
                                            <div class="col-lg-12 col-sm-12 col-12 p-0 pt-2">
                                                <div class="checkbox-wrapper-4">
                                                    ...
                                                    <label class="cbx" for="morning2"><span>
                                                            <svg width="12px" height="10px">
                                                                <use xlink:href="#check-4"></use>
                                                            </svg></span><span>Save this information for next
                                                            time</span></label>
                                                    <svg class="inline-svg">
                                                        <symbol id="check-4" viewbox="0 0 12 10">
                                                            <polyline points="1.5 6 4.5 9 10.5 1"></polyline>
                                            ...
                                            <div class="col-lg-12 col-sm-12 col-12 p-0 pt-0">
                                                <div class="checkbox-wrapper-4">
                                                    ...
                                                    <label class="cbx" for="morning3"><span>
                                                            <svg width="12px" height="10px">
                                                                <use xlink:href="#check-4"></use>
                                                            </svg></span><span>Text me with news and
                                                            offers</span></label>
                                                    <svg class="inline-svg">
                                                        <symbol id="check-4" viewbox="0 0 12 10">
                                                            <polyline points="1.5 6 4.5 9 10.5 1"></polyline>
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="card main-border">
                                                    <div class="card-header border-0 custom-card-header bg-white">
                                                        <h5 class="mb-0">
                                                            <label
                                                                class="mb-0 d-flex align-items-center custom-card-header">
                                                                <input type="radio" class="pl-3 section-radio-2"
                                                                    name="same_shipping_address"
                                                                    data-target="#section42" aria-expanded="true" />
                                                                <p
                                                    ...
                                                    <div class="card-header border-0 custom-card-header bg-white">
                                                        <h5 class="mb-0">
                                                            <label
                                                                class="mb-0 d-flex align-items-center custom-card-header">
                                                                <input type="radio" class="pl-3 section-radio-2"
                                                                    name="difrent_address" data-target="#section41"
                                                                    aria-expanded="false" />
                                                                <p
                                                                    style="margin-left: 1rem;font-size: 16px;color: black;">
                                                            ...
                                                            <div class="row p-2">
                                                                ...
                                                                <div class="col-lg-6 col-sm-12 col-12 pl-0 pr-1 ">
                                                                    <div class="bor8 bg0 m-b-10">
                                                                        <input type="text"
                                                                            class="stext-111 cl8 plh3 size-111 p-lr-15"
                                                                            id="validationCustom01" placeholder="City"
                                                                            required />
                                                                    </div>
                                                                </div>
                                                                <div
                                                                    class="col-lg-6 col-sm-12 col-12 pr-0 check-field">
                                                                    <div class="bor8 bg0 m-b-10">
                                                                        <input type="text"
                                                                            class="stext-111 cl8 plh3 size-111 p-lr-15"
                                                                            id="validationCustom01"
                            ...
                            <div class="card-header border-0 custom-card-header bg-white">
                                <h5 class="mb-0">
                                    <label class="mb-0 d-flex align-items-center custom-card-header">
                                        ...
                                        <p style=" font-size: 16px; color: black; margin-left: 1rem;">
                                            Bkash
                                        </p>
                                    </label>
                                </h5>
            ...
            <div class="col-lg-6">
                <div class="checkout-sidebar-info-main">
                    <div class="row align-items-center">
                                    ...
                                    <div class="d-flex justify-content-between p-2"
                                        ...
                                        <a href="">
                                            <div class="header-cart-item-img">
                                                <span
                                                    class="badge badge-dark rounded-circle count-label">{{ $cartItem['quantity'] }}</span>
                                        ...
                                        <div class="w-75">
                                            <p class="p-0 m-0 pt-2">{{ $cartItem['name'] }}</p>
                                            <p class="p-0 m-0">{{ $cartItem['quantity'] }}</p>
                                        </div>
                                        <div>
                                            <p class="p-0 m-0 mt-4 text-info">৳
                        ...
                        @else
                            <div class="col-lg-12 mb-2">
                                <h5 class="text-center text-danger">No Product in the Cart.</h5>
                            </div>
                        @endif
                    </div>
                    <form action="">
                    ...
                    <div class="row mt-5">
                        <div class="col-lg-12 col-sm-12">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <p class="text-right">৳ <span class="shipping">0.00</span></p>
                            </div>
                            <div class="d-flex justify-content-between">
                            ...
                            <div class="d-flex justify-content-between pt-4">
                                <h6 class="text-left pb-2 bold text-black" style="color: #000000; font-weight: bold">
                                    Total(Including 0% VAT)
                                </h6>
                                <h6 class="text-right">
                                    BDT ৳
                                    <span class="total_value_show"
                                        style="color: #000000; font-weight: bold">{{ $total }}</span>
                                </h6>
                            </div>
                        </div>
                    </div>
